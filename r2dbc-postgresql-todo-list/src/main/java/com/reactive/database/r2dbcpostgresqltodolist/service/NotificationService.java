...
import com.reactive.database.r2dbcpostgresqltodolist.exception.NotificationDeserializationException;
...
public class NotificationService {
    ...
    /**
     * Create an object mapper to convert the json notification parameters to entities
     *
